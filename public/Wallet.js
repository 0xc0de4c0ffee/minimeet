...
// Expose callback setters for external use (e.g. login screen)
window.setWalletOnConnect = function(cbs) { _onConnectCallbacks = Array.isArray(cbs) ? cbs : [cbs]; };
window.setWalletOnDisconnect = function(cbs) { _onDisconnectCallbacks = Array.isArray(cbs) ? cbs : [cbs]; };
